...
function myPow() {
    ...
    let pow = parseInt(prompt('Enter exponent'));
    while(pow>0){
        pow--;
        r = num * r;
    }
...
function divider(){
    ...
    let final = '';
    let limite = (num_1>num_2)?num_1:num_2;
    let divader = 1;
...
function range(){
    let from = parseInt(prompt("Enter from"));
    let to = parseInt(prompt("Enter to"));
    let result = '';
    for (let i = from; i<=to; i = i + 4){
